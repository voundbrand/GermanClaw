...
openclaw voicecall outcomes --last 200
...
- Terminal calls are projected to `outcomes.jsonl` as deterministic `intake_outcome_v1` envelopes for downstream dispatch/SLA workers.
